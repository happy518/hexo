...
> 
> [我的的博客](http://www.happy518.top)

# 前言
从 Jekyll 到 GitHub Pages 中间踩了许多坑，终于把我的个人博客[PB Blog](http://wwww.happy518.top)搭建出来了。。。

本教程针对的是不懂技术又想搭建个人博客的小白，操作简单暴力且快速。当然懂技术那就更好了。

看看看博客的主页样式：

[![](https://upload-images.jianshu.io/upload_images/14423059-7670862c89de1ac7.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)](http://www.happy518.top/)

在手机上的布局：

[![](https://upload-images.jianshu.io/upload_images/14423059-8d1fd5ff91e13811.jpg)](http://www.happy518.top/)
...
注册完成后搜索 `happy518.github.io` 进入[我的仓库](https://github.com/happy518/happy518.github.io)
...
url: "https://happy518.github.io"          # 这个就是填写你的博客地址
baseurl: ""      # 这个我们不用填写
...
一个主机记录为 `www`,代表可以解析 `www.happy518.top`的域名
